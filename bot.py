...
def get_data(update, context):
  global sheet
  reset_daily_sheet_month(sheet)
  message = get_total_data(
      sheet
  ) + " Nếu bạn muốn xem thêm, vui lòng <a href='https://docs.google.com/spreadsheets/d/1-Ouzw_BGRgt-8ZxQVA33FHO_V2sDcrDbFUSfPQm4rwU/edit?usp=sharing'>ấn vào đây</a>"
...
def main():
  ...
  updater = Updater('6081198225:AAFL7zPIho4vOPGAh-kP0uEraCnK4lMJW_4',
                    use_context=True)
